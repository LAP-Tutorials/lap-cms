            ...
            <Tabs defaultValue="write" className="w-full flex-1 flex flex-col">
              ...
              >
                ...
                <Textarea
                  ...
                  className="flex-1 min-h-[500px] text-lg leading-relaxed border-white/10 focus-visible:ring-0 focus-visible:border-white/20 resize-y p-6 font-[family-name:var(--font-fira-code)] bg-transparent placeholder:text-white/20"
                />
              </TabsContent>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-1.5 relative">
                ...
                {showSuggestions && authors.length > 0 && (
                  <div
                    ref={suggestionsRef}
                    className="absolute z-20 w-full border border-white/10 bg-[#252525] mt-1 max-h-48 overflow-y-auto rounded-md shadow-xl"
                  >
                    {authors
                      .filter((a) =>
                        a.name.toLowerCase().includes(authorName.toLowerCase())
