      ...
      <form onSubmit={handleCreate} className="max-w-4xl">
            ...
            <div className="mb-6">
              ...
              <div className="flex flex-col items-center space-y-4">
                ...
                <Input
                  ...
                  className="w-full"
                />
                <p className="text-sm text-white/50 text-center">Image alt text is used for accessibility</p>
              </div>
            </div>
          </div>
          ...
          <div className="md:col-span-2">
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-sm text-white/50 mt-1">Auto-generated from name</p>
              </div>

              <div>
                <label className="block mb-2 font-medium">Country:</label>
                <Input value={city} onChange={(e) => setCity(e.target.value)} placeholder="Member country" />
              </div>

              <div>
                <label className="block mb-2 font-medium">Job:</label>
                <Input value={job} onChange={(e) => setJob(e.target.value)} placeholder="Member job title" />
              </div>
              ...
              <div>
                ...
                <Input
                  ...
                  minLength={6}
                />
                <p className="text-sm text-white/50 mt-1">Password must be at least 6 characters long</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 border border-white/10 p-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-6">
            ...
            <div className="flex items-end">
              <Button type="button" onClick={handleAddSocial} className="h-10 whitespace-nowrap"  variant="outline">
              ...
              <ul className="divide-y divide-white/10">
                {Object.entries(socials).map(([platform, link]) => (
                  <li key={platform} className="flex justify-between items-center p-4">
                    ...
                    <Button type="button"  variant="outline" size="icon" onClick={() => handleRemoveSocial(platform)}>
                      <X className="h-4 w-4" />
                    </Button>
                  </li>
                ))}
        ...
        <div className="flex flex-wrap gap-4 mt-8">
          ...
          <Button
            ...
            variant="outline"
            onClick={() => {
              if (window.confirm("Are you sure you want to cancel? Any information you've entered will be lost.")) {
                router.push("/admin/team")
              }
            }}
            disabled={creating}
