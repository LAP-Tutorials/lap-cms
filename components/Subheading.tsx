...
export default function Subheading({
  ...
  return (
    <div className="flex justify-between">
      <h2
        className={`mt-4 mb-8 md:mt-12 md:mb-16 max-w-[95rem] w-full mx-auto text-white ${className}`}
      >
        {children}
      </h2>
      <Link
        className="flex justify-end items-center gap-2 uppercase font-semibold w-full text-white"
        href={url}
      >
